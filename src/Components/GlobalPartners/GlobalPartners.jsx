        ...
        <div className="bg-[#F9FAFB] py-20">
            <div className="lg:w-11/12 mx-auto flex flex-col items-center gap-8">
                ...
                <div className="mt-10 grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 w-11/12 mx-auto gap-8">
                    ...
                    {globalPartners.map(eachPartner => (
                        <a
                            key={eachPartner.id}
                            href={eachPartner.website}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group bg-white border border-gray-200 rounded-xl p-8 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:border-orange-500 flex justify-center items-center"
                        >
                            <img
                                className="max-h-24"
                                src={eachPartner.logo}
                                alt={eachPartner.name}
                            />
                        </a>
                    ))}
                ...
                <NavLink
                    to="/partners"
                    className="flex w-[300px] mt-4 justify-center items-center gap-2 px-4 py-4 border-2 border-[#103870] text-[#103870] font-inter font-bold text-xl text-center transition-colors duration-300 ease-in-out hover:bg-[#103870] hover:text-white rounded lg:mr-6"
                >
                    View Our Pertners
