...
import { Clock, Shield, Cog, Users } from "lucide-react";
...
const InstallationValuesCards = () => {
    ...
    useEffect(() => {
        fetch("/services.json")
            .then((res) => res.json())
            .then((data) => {
                // Use installation.features from the JSON
                setFeatures(data.installation?.features || []);
            });
    }, []);
...
export default InstallationValuesCards;